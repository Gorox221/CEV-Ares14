...
server-currency-name-singular = Арес-коин
server-currency-name-plural = Арес-коины
...
gs-balanceui-shop-buy-token-antag = Купить токен антага - { $price } Арес-коинов
gs-balanceui-shop-buy-token-admin-abuse = Купить токен на злоупотребление админом - { $price } Арес-коинов
gs-balanceui-shop-buy-token-hat = Купить токен на шляпу - { $price } Арес-коинов
